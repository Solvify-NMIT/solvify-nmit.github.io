...
const Footer = () => {
  ...
  return (
    <footer className="relative w-full bg-[#050505] text-white pt-12 md:pt-16 pb-6 md:pb-8">
      {/* Top border with gold accent */}
      <div className="absolute top-0 left-0 right-0 h-[2px] bg-[#FFD700]/20"></div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Main content grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-8 lg:gap-16 mb-10 md:mb-12">
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              />
              <div>
                <h1 className="font-bebas text-xl md:text-2xl lg:text-3xl font-bold text-[#FFD700] drop-shadow-[0_0_10px_rgba(255,215,0,0.4)] tracking-wide mb-1">
                  SOLVIFY
                </h1>
                <p className="font-montserrat text-sm md:text-base text-white/80 font-medium">
            ...
            <div className="flex gap-3 mt-2">
              {[
                ...
                <button
                  ...
                  className="w-10 h-10 md:w-11 md:h-11 flex items-center justify-center rounded-full border-2 border-[#FFD700] text-[#FFD700] hover:bg-[#FFD700] hover:text-[#050505] transition-all duration-300 cursor-pointer hover:scale-110 hover:shadow-[0_0_15px_rgba(255,215,0,0.6)]"
                  aria-label={social.label}
                >
                  <svg className="w-5 h-5 md:w-5.5 md:h-5.5" fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            <h3 className="font-montserrat text-base md:text-lg font-bold text-white mb-5 md:mb-6 relative pb-2">
              Quick Links
            ...
            <ul className="flex flex-col gap-0.5 md:gap-1">
              {[
                ...
                <li key={item.href}>
                  <Link
                    href={item.href}
                    className="font-montserrat text-sm md:text-base text-white/70 hover:text-[#FFD700] hover:drop-shadow-[0_0_8px_rgba(255,215,0,0.5)] transition-all duration-300"
                  >
                    {item.label}
                  </Link>
                </li>
          ...
          >
            ...
            <div className="flex flex-col gap-0.5 md:gap-1">
              <p className="font-montserrat text-sm md:text-base text-white/70">
                Nitte Meenakshi Institute of Technology
              </p>
              <p className="font-montserrat text-sm md:text-base text-white/70">
                Yelahanka, Bengaluru
            ...
            <Link
              ...
              className="font-montserrat text-sm md:text-base text-white/70 hover:text-[#FFD700] hover:drop-shadow-[0_0_8px_rgba(255,215,0,0.5)] transition-all duration-300 mt-2"
            >
              solvify@nmit.ac.in
            </Link>
          </motion.div>
        ...
        {/* Divider */}
        <div className="h-px bg-gradient-to-r from-transparent via-[#FFD700]/20 to-transparent mb-6 md:mb-8"></div>
        ...
        >
          <p className="font-montserrat text-xs md:text-sm text-white/60 text-center sm:text-left">
          ...
          <div className="flex gap-4 md:gap-6 text-xs md:text-sm">
            <Link
              href="#privacy"
              className="font-montserrat text-white/60 hover:text-[#FFD700] hover:drop-shadow-[0_0_8px_rgba(255,215,0,0.5)] transition-all duration-300"
            >
              Privacy Policy
            </Link>
            <Link
